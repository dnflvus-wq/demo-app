# Experiment: gpt-5-mini model + tuned instructions + cnt=15
...
Write-Host "Starting TC generation (gpt-5-mini + tuned instructions + cnt=15)..."
...
$response | ConvertTo-Json -Depth 10 | Out-File -FilePath "c:\Project\demo-app\experiments\exp3_model5mini_result.json" -Encoding UTF8
Write-Host "Completed. Saved to exp3_model5mini_result.json"
