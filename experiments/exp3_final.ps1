# FINAL Experiment: gpt-5-mini + tuned instructions v2 + cnt=20
...
Write-Host "Starting FINAL experiment (gpt-5-mini + tuned v2 + cnt=20)..."
...
$response | ConvertTo-Json -Depth 10 | Out-File -FilePath "c:\Project\demo-app\experiments\exp3_final_result.json" -Encoding UTF8
Write-Host "FINAL experiment completed. Saved to exp3_final_result.json"
