# Experiment: gpt-4.1-mini model + tuned instructions + cnt=15
...
Write-Host "Starting TC generation (gpt-4.1-mini + tuned instructions + cnt=15)..."
...
$response | ConvertTo-Json -Depth 10 | Out-File -FilePath "c:\Project\demo-app\experiments\exp3_model41mini_result.json" -Encoding UTF8
Write-Host "Completed. Saved to exp3_model41mini_result.json"
